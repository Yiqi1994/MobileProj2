...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        highlightTextColor = UIColor.init(red: 34/255.0, green: 193/255.0, blue: 34/255.0, alpha: 1.0)
        iconColor = UIColor.init(white: 0.0/255.0, alpha: 1.0)
        highlightIconColor = UIColor.init(red: 34/255.0, green: 193/255.0, blue: 34/255.0,  alpha: 1.0)
        //backdropColor = UIColor.init(white:0.0, alpha: 1.0)
